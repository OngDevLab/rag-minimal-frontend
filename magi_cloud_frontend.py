...
df = conn.query('SELECT error_message, response, prompt, feedback, id FROM public.magi_kb;', ttl="10m")
...
grid_builder.configure_columns(['error_message', 'response','prompt','feedback','id'], wrapText=True, autoHeight=True, width=420)
